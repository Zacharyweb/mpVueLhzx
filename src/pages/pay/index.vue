<template>
  <div class="container">
    <div class="top_tips">
      ...
      {{i18n.LANGTYPE == 'cn_j'?'请在24小时内完成支付，逾期专家可打您电话查询。':'please make payment in 24 hours following the reply.If not,the advisor may call to inquire'}}
    </div>
    ...
    <div class="order_form_panel">
      <div class="panle_block nb">
        <div class="pay_detail">
          <div
            class="tips1"
          >{{i18n.LANGTYPE == 'cn_j'?'长按下方图片保存专家收款二维码直接付款给专家。':'Fee shall be paid to advisor directly via his/her WeChat QR Code'}}</div>
        </div>
      ...
      <div class="panle_block npb">
        ...
        <div class="pay_step" v-else>
          ...
          <div
            class="step_sub_tetx"
          >please pay in 24 hours following the reply. If not, the advisor may call to inquire.</div>
        </div>
...
export default {
  ...
  methods: {
    ...
    GetUserPayCodeImg() {
      let url = API["GetUserPayCodeImg"] + this.expertId;
      this.$http
        .request({
          url: url
        })
